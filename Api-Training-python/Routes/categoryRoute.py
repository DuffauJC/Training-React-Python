...
@router.get("/categoryById/{category_id}",response_model=schemas.CategoryRead)
...
@router.post("/categoryCreate/",response_model=schemas.CategoryRead)
...
@router.put("/categoryUpdate/{category_id}",response_model=schemas.CategoryUpdate)
...
@router.delete("/categoryDelete/{category_id}")
